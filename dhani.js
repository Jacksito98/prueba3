...
mess = {
wait: '*Eperate gil*',
eror: '*Disculpe, ocurrió un error!!*',
success: '*Listo*',
error: {
stick: '*Eso no es un sticker mamaguevo !!*',
Iv: '* Link invalido pica de aca gay !!*'
},
only: {
...
owner: '*Características especiales del propietario rueda rapidisimo de ahi singa perra!!*',
...
const daftar1 = `Eyy qlq  ${pushname} ${ucapanWaktu} \n\nAntes de acceder al bot, verificate primero`
const daftar2 = '```preciona el botón de abajo para verificarte mi loco\nSi no te aparece el boton, escriba #verify```'
...
reply(` *「 DETECTOR DE ENLACE DE GRUPO」*\nEnviaste un enlace de un grupo,en vre te saco por mamguevo .`)
setTimeout(() => {
Dhani.groupRemove(from, [kic]).catch((e) => { reply(`LOS BOTS DEBEN SER ADMINISTRADORES`) })
}, 0)
}
...
reply(`「 *VIRTEX DETECTOR* 」\n\nEnviaste un virtex o traba, lo siento, te echaron del grupo.`)
...
${gaya1} *Nombre del Bot* : ${botname}
${gaya1} *Nombre del Owner* : ${ownername}
${gaya1} *Numero del Owner* : @${pemilik.split('@')[0]}
${gaya1} *Hostname :* ${os.hostname()}
${gaya1} *Platform :* ${os.platform()}
${gaya1} *Wa Version :* ${Dhani.user.phone.wa_version}
${gaya1} *Total registros :* ${_registered.length}
${gaya1} *Mode :* ${self ? "Self" : "Public"}
${gaya1} *lectura automática* : ${autoread ? "Aktif" : "Off"}
...
${gaya1} *Info* : ${bio_user}
${gaya1} *Tag* : @${senderr.split('@')[0]}
${gaya1} *Status* : ${isOwner ? 'Owner' : 'User'}`
teks =
`_Seleccione el botón a continuación _
_Si no te aparecen _
_Por favor escribe ${prefix}command_
Sigueme en insta como @Jack_Paymon`
Dhani.sendMessage(from, { contentText: `${menu}`, footerText: `${teks}`, buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: 'ᴄᴏᴍᴍᴀɴᴅ' }, type: 1 },{ buttonId: `${prefix}donaciones`, buttonText: { displayText: 'donaciones' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [senderr,pemilik]}}}, 'buttonsMessage')
...
case 'allmenu':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
reply(`*_Lo siento Características${prefix + command} No disponible Por favor escriba${prefix}command_*`)
break
case 'grupmenu':
case 'groupmenu':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
${gaya2} ${prefix}botsito _pregunta_
...
\`\`\`Privado:\`\`\`
➪ *Script privado :* _Póngase en contacto con el propietario_
Para los que quieren comprar el script/sc 
Puede solicitar si está interesado, póngase en contacto con Jacksito98
numero : https://wa.me/+27834444444`
Dhani.sendMessage(from, { contentText: `${menu}`, footerText: `*_${tanggal} - ${time} WIB_*`, buttons: [{ buttonId: `${prefix}donaciones`, buttonText: { displayText: 'Dᴏɴᴀᴄɪᴏɴᴇ' }, type: 1 },{ buttonId: `${prefix}owner`, buttonText: { displayText: 'ᴏᴡɴᴇʀ' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [senderr]}}}, 'buttonsMessage')
break
case 'donaciones':
case 'donar':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
• No amigos con tan solo seguirme en mi cuenta de instagram y suscribirte en mi canal ya lo es todo
• Ig:aparesco como Jack_paymon 

• youtube: https://www.youtube.com/channel/UCTfpv-KmckjC1rwPKqw_t1w

y Nada no hagas spam de comandos por favor :3 `
but = [
...
text1 = `Haga clic en siguiente para ir a${command} próximo`
text2 = `por favor no envíes spam!!`
but = [{ buttonId: `${prefix+command}`, buttonText: { displayText: '️NEXT ➡️' }, type: 1 }]
sendButImage(from, text1, text2, buffer, but, {quoted: mek})
break
...
text2 = `Haga clic en siguiente para ir ${command} próximo`
but = [{ buttonId: `${prefix+command}`, buttonText: { displayText: '️NEXT ➡️' }, type: 1 }]
sendButMessage(from, buffer, text2, but, {quoted: mek})
break
case 'quoteskanye':
...
text1 = `Haga clic en siguiente para ir ${command} próximo`
text2 = `por favor no envíes spam!!`
but = [{ buttonId: `${prefix+command}`, buttonText: { displayText: '️NEXT ➡️' }, type: 1 }]
sendButImage(from, text1, text2, buffer, but, {quoted: mek})
break
...
Teks = `Haga clic en Siguiente para ir a${command} Próximo`
text1 = `Haga clic en Siguiente para ir a${command} Próximo`
text2 = `por favor no envíes spam!!`
but = [{ buttonId: `${prefix+command}`, buttonText: { displayText: '️NEXT ➡️' }, type: 1 }]
sendButImage(from, text1, text2, buffer, but, {quoted: mek})
...
Dhani.sendMessage(from, oke, image, {quoted: mek, caption: '*By: JᴀᴄᴋSɪᴛᴏ-⃫⃟冰⁩他妈的*'})
break
case 'hartatahta': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (args.length < 1) return reply(`*Dónde está el texto?*\n_Ejemplo: ${prefix + command} Su nombre_`) 
...
Dhani.sendMessage(from, harta, image, {quoted: mek, caption: '*By: JᴀᴄᴋSɪᴛᴏ-⃫⃟冰⁩他妈的*'})
break
...
case 'sourcode':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
fakeitem(`_Pase por este canal_\n_Porque hay un script de bot genial ²_\n_ No pases por aquí, es una gran pérdida_\n_https://www.youtube.com/channel/UCTfpv-KmckjC1rwPKqw_t1w_`)
break
case 'rules':
case 's&k':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
case 'runtime':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
textImg(`Bot activo durante ${runtime(process.uptime())}`)
break
case 'ping':
case 'speed':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
timestampe = speed();
latensie = speed() - timestampe
textImg(`「 *𝙎𝙋𝙀𝙀𝘿 𝙏𝙀𝙎𝙏* 」\nEl bot responde en ${latensie.toFixed(4)} Sec 💬`)
break
case 'd':
case 'del':
case 'delete':
...
case 'verify':
case 'daftar':
if (isRegistered) return textImg('_Mi loco ya te registraste, tienes alzheimer o que ?_')
const serialUser = createSerial(18)
veri = sender
_registered.push(sender)
fs.writeFileSync('./database/registered.json', JSON.stringify(_registered))
addRegisteredUser(sender, serialUser)
const jancok = `「 *REGISTRO DE USUARIO* 」

👤 *Nombre :* ${pushname}
🐣 *Numero :* @${sender.split('@')[0]}
💌 *Serial :* ${serialUser}
🌻 *Usuarios totales:* ${_registered.length}

*「 ${botname} 」*`
gbutsan = [
{buttonId:`${prefix}menu`,buttonText:{displayText:'𝙈𝙀𝙉𝙐'},type:1},
{buttonId:`${prefix}rules`,buttonText:{displayText:'𝙍𝙀𝙂𝙇𝘼𝙎'},type:1}
]
mhan = await Dhani.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const sendBtnVeryy = {
imageMessage: mhan.message.imageMessage,
contentText:`${jancok}`,
footerText:'Gracias por registrarte, ahora pica de aca Mmgvo', 
buttons: gbutsan,
headerType: 4
}
...
apakah = body.slice(1)
const apa =['sí','No','Podría ser','Definitivamente']
const kah = apa[Math.floor(Math.random() * apa.length)]
Dhani.sendMessage(from, 'Pregunta : *'+apakah+'*\n\nResponder: '+ kah, text, { quoted: mek })
break
case 'kapankah':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (!isGroup) return reply(mess.only.group)
...
Dhani.sendMessage(from, 'Pregunta: *'+sange+'*\n\nrespuesta : '+ nge+'%', text, { quoted: mek })
break
case 'cekgay':
case 'gaycek':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
Dhani.sendMessage(from, 'Pertanyaan : *'+lesbii+'*\n\nrespuesta : '+ bi+'%', text, { quoted: mek })
break
case 'cekme':
case 'me':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (!isGroup) return reply(mess.only.group)
reply("¡Espere!, escanee el número y el nombre")
neme = args.join(" ")
bet = `${sender}`
const sifat =['Multas', 'Hostil', 'Molesto', 'Decepcionado', 'Gruñón', 'Educado', 'Cargando', 'Sange', 'Cringe', 'Mentiroso']
const hoby =['Cocinar','Ayudar a Atok','Mabar','Nobar','Sosmedtan','Ayudar a otros','Ver anime','Ver drama','Montar en motocicleta','Cantar','Bailar',' Golpeando','Dibujando','Las fotos no son claras','Jugando','Habla contigo mismo']
...
const cakep =['Es tan lindo', 'Lo siento loco, hay mucho trato', 'Eso es feo', 'Tan lindo😍','❌','✔️']
const wetak=['Cariñoso',' Generoso', 'Enojado', 'Perdonador', 'Obediente', 'Bueno', 'Papel', 'Amable', 'Paciente', 'UwU', 'top deh, básicamente', 'Me gusta ayudar']
...
teks = `*La mayor carga aquí es:* @${beb.jid.split('@')[0]}`
membr.push(beb.jid)
...
teks = `*El más pajero aquí es:* @${ba.jid.split('@')[0]}`
membr.push(ba.jid)
mentions(teks, membr, true)
break
case 'ngewe':
...
teks = `El que flipó ayer en este grupo es@${akuut.jid.split('@')[0]} dan️ @${diaat.jid.split('@')[0]}`
jds.push(akuut.jid)
jds.push(diaat.jid)
...
teks = `*Lo más sangriento aquí es:* @${goo.jid.split('@')[0]}`
membr.push(goo.jid)
mentions(teks, membr, true)
break
case 'gay':
...
teks = `*El más cansado aquí es:* @${bc.jid.split('@')[0]}`
membr.push(bc.jid)
mentions(teks, membr, true)
break
case 'homosexual':
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (!isGroup) return reply(mess.only.group)
text1 = `Por favor, elija uno para jugar traje`
text2 = `Espero que ganes`
but = [
...
reply(`Enviar una imagen con el comando${prefix}sticker\nDuración del sticker de video 1-9 segundos`)
}
break
case 'toimg':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
fs.unlinkSync(media)
if (err) return reply('Error al convertir la etiqueta en imagen')
buffer = fs.readFileSync(ran)
Dhani.sendMessage(from, buffer, image, {quoted: mek, caption: 'Jacksito98'})
fs.unlinkSync(ran)
})
break
...
reply(`_Este es mi dueño no lo azaren mucho que se estresa rapido xDD_`)
break
case 'bcnowm':
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (!isOwner && !mek.key.fromMe) return reply(mess.only.owner)
if (!isQuotedImage) return reply(`Enviar una imagen con un título.${prefix}setppbot o etiquetar imágenes que ya han sido enviadas`)
...
reply('Gracias por la nueva foto de perfil, mi querido dueño.😚')
break
case 'setbio':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (!isOwner && !mek.key.fromMe) return reply(mess.only.owner)
...
reply(`Éxito al cambiar el nombre del bot a${body.slice(11)}`)
break
case 'set':
case 'mode':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
menu = `Por favor elige uno\nPara habilitar/deshabilitar la función de lectura automática`
but = [
...
autoketik = true
reply('Succes..')
reply('Recuerde que si el modo automático está activado, desactívelo primero.')
} else if(args[0] == 'off'){
autoketik = false
reply('Succes..')
} else if (!c){
menu = `Por favor elige uno\nPara habilitar/deshabilitar las funciones de escritura automática`
but = [
...
autovn = true
reply('Succes..')
reply('Recuerde que si el autotipo está activado, desactívelo primero.')
} else if(args[0] == 'off'){
autovn = false
reply('Succes..')
} else if (!c){
menu = `Por favor elige uno\nPara habilitar/deshabilitar funciones automáticas`
but = [
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (!mek.key.fromMe && !isOwner) return reply(mess.only.owner)
if (!arg) return reply(`Utilizar ${prefix}spam de texto | cantidad`)
argzi = arg.split("|")
if (!argzi) return reply(`Utilizar${prefix}spam de texto | cantidad`)
...
if (args[0] === 'on') {
if (isNsfw) return reply('Ya esta activa gilaso')
_nsfw.push(from)
fs.writeFileSync('./database/nsfw.json', JSON.stringify(_nsfw))
reply(`\`\`\`Listo ✅, La funcion Pajera esta activa en el grupo\`\`\` *${groupMetadata.subject}*`)
} else if (args[0] === 'off') {
if (!isNsfw) return reply('Esta muerta mmgvo')
var ini = _nsfw.indexOf(from)
_nsfw.splice(ini, 1)
fs.writeFileSync('./database/nsfw.json', JSON.stringify(_nsfw))
reply(`\`\`\`Listo ✅, La funcion Pajera esta desactiva en el grupo \`\`\` *${groupMetadata.subject}*`)
} else if (!c){
anu =`Por favor elige uno\nPara la función nsfw`
...
if (args[0] === 'buka') {
reply(`*Grupo abierto con éxito${groupMetadata.subject}*`)
Dhani.groupSettingChange(from, GroupSettingChange.messageSend, false)
} else if (args[0] === 'tutup') {
reply(`*Grupo cerrado con éxito${groupMetadata.subject}*`)
...
if (!isGroupAdmins && !mek.key.fromMe) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Etiqueta al target que quieres que sea administrador!')
...
mentions(`Orden recibida, @${mentioned[0].split('@')[0]} Eres un administrador en el grupo.*${groupMetadata.subject}*`, mentioned, true)
Dhani.groupMakeAdmin(from, mentioned)
}
break
case 'demote' :
...
if (!isGroupAdmins && !mek.key.fromMe) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Etiqueta al target que quieres que no sea administrador!')
mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
if (mentioned.length > 1) {
...
mentions(`Pedido recibido, Inferior: @${mentioned[0].split('@')[0]} Hazte miembro`, mentioned, true)
Dhani.groupDemoteAdmin(from, mentioned)
}
break
case 'demoteall':
...
return reply("Etiqueta al objetivo que quieres sacar pa hacerlo comer mierda!");
mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid;
if (mentioned.length > 1) {
...
Dhani.sendMessage(from, `\`\`\`Éxito, se cambió el nombre del grupo a\`\`\` *${body.slice(9)}*`, text, { quoted: fgi })
break
case 'setdesc':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (!isGroup) return reply(mess.only.group)
...
Dhani.sendMessage(from, `\`\`\`Correcto, se modificó la descripción del grupo.\`\`\` *${groupMetadata.subject}* Volverse: *${body.slice(9)}*`, text, { quoted: fgi })
break
case 'setppgrup':
case 'setpp':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
reply(`Enviar o etiquetar una imagen con un título${prefix}setppgrup`)
}
break
case 'hidetag':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
let ingfo = `*G R O U P I N F O*\n\n*Name :* ${groupName}\n*ID Grup :* ${from}\n*Hecho:* ${moment(`${groupMetadata.creation}` * 1000).tz('Asia/Jakarta').format('DD/MM/YYYY HH:mm:ss')}\n*Owner Grup :* @${groupMetadata.owner.split('@')[0]}\n*Jumlah Admin :* ${groupAdmins.length}\n*Jumlah Peserta :* ${groupMembers.length}\n*Welcome :* ${isWelkom ? 'Aktif' : 'Mati'}\n*AntiLink :* ${isAntiLink ? 'Aktif' : 'Mati'}\n*Desc :* \n\n${groupMetadata.desc}`
...
reply(`responder imagen/pegatina/audio/video con subtítulo${prefix}totag`)
}
break
case 'listadmin':
case 'adminlist':
...
if (!isGroup) return reply(mess.only.group)
options = {
text: `Aquí está el dueño del grupo.: https://wa.me/${from.split("-")[0]}`,
